...
plaidRouter.post('/api/set_access_token', function (request, response, next) {
...
plaidRouter.get('/api/auth', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/transactions', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/identity', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/balance', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
// https://plaid.com/docs/#investments
plaidRouter.get('/api/holdings', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/liabilities', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/item', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/assets', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.get('/api/payment', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
plaidRouter.use('/api', function (error, request, response, next) {
  prettyPrintResponse(error.response);
  response.json(formatError(error.response));
});

const server = plaidRouter.listen(APP_PORT, function () {
...
plaidRouter.get('/api/transfer_authorize', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
      const accountsResponse = await client.accountsGet({
        access_token: ACCESS_TOKEN,
...
plaidRouter.get('/api/transfer_create', function (request, response, next) {
  Promise.resolve()
    .then(async function () {
